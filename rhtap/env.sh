...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/zhcdoem52-dotnet-basic-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.em32m-ocye3-7rp.yf6m.p3.openshiftapps.com}
